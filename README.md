...
Github is a website collaboration community with a variety of mechanisms for everyone to work with you to contribute to the project. This readme file is written for people who have no experience in Github and Jekyll but have some acknowledgment about Atom and Markdown. In this readme file, you will learn how to use Github to host your resume with a Jekyll theme. <br />
<hr>
